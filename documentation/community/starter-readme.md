[![Build Status](https://travis-ci.com/Pray4Movement/pray4movement-site-porch.svg?branch=master)](https://travis-ci.com/Pray4Movement/pray4movement-site-porch)
...
#### Framework
 ...
 1. Disciple.Tools Theme presence check. ```pray4movement_site_porch()```
...
[Issues](https://github.com/Pray4Movement/pray4movement-site-porch/issues) section of the repo. You can present ideas
in the [Discussions](https://github.com/Pray4Movement/pray4movement-site-porch/discussions) section of the repo. And
code contributions are welcome using the [Pull Request](https://github.com/Pray4Movement/pray4movement-site-porch/pulls)
system for git. For a more details on contribution see the
[contribution guidelines](https://github.com/Pray4Movement/pray4movement-site-porch/blob/master/CONTRIBUTING.md).
